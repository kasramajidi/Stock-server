...
import { Package, RefreshCw, ChevronDown, ChevronUp, Check, X } from "lucide-react";
    ...
    <div className="p-6 md:p-8 lg:p-10">
      <div className="max-w-5xl mx-auto" style={{ animation: "adminFadeIn 0.4s ease-out" }}>
        <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
          <div>
            <h1 className="text-2xl font-bold text-slate-100">کامنت محصولات</h1>
            <p className="text-slate-400 text-sm mt-1">تایید، رد و پاسخ به کامنت‌های محصولات</p>
          </div>
          <button
            type="button"
            onClick={load}
