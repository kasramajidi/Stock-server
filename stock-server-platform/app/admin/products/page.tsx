      ...
      <div className="max-w-5xl mx-auto w-full min-w-0" style={{ animation: "adminFadeIn 0.4s ease-out" }}>
        <div className="flex flex-wrap items-center justify-between gap-3 sm:gap-4 mb-4 sm:mb-6">
          <div className="min-w-0">
            <h1 className="text-xl sm:text-2xl font-bold text-slate-800 dark:text-slate-100">محصولات</h1>
            <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">مدیریت و افزودن محصولات فروشگاه</p>
          </div>
          ...
          <>
            ...
            >
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {products.map((p) => (
                      ...
                      >
                        <td className="p-3 font-medium text-slate-800 dark:text-slate-100">{p.title}</td>
                        ...
                        <td className="p-3 text-slate-500 dark:text-slate-400">{p.viewCount}</td>
                        <td className="p-3">
              ...
              {products.length === 0 && !loading && (
                <div className="p-8 text-center text-slate-500 dark:text-slate-400">محصولی ثبت نشده است.</div>
              )}
            </div>
            ...
            {totalPages > 1 && (
              <div className="flex flex-wrap items-center justify-center gap-2 mt-6">
                <button
                  ...
                  disabled={page <= 1}
                  className="flex items-center gap-1 rounded-lg border border-slate-400 dark:border-slate-600 bg-slate-300/50 dark:bg-slate-700/50 px-3 py-2 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-400 dark:hover:bg-slate-600 disabled:opacity-40 disabled:cursor-not-allowed"
                >
