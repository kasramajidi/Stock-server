...
import { FileText, RefreshCw, ChevronDown, ChevronUp, Check, X, Trash2 } from "lucide-react";
      ...
      <div className="max-w-5xl mx-auto w-full min-w-0" style={{ animation: "adminFadeIn 0.4s ease-out" }}>
        <div className="flex flex-wrap items-center justify-between gap-3 sm:gap-4 mb-4 sm:mb-6">
          <div className="min-w-0">
            <h1 className="text-xl sm:text-2xl font-bold text-slate-800 dark:text-slate-100">کامنت مقالات</h1>
            <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">تایید، رد و پاسخ به کامنت‌ها</p>
          </div>
          <button
            type="button"
            onClick={load}
