...
export default function AboutPage() {
  return (
    <main className="min-h-screen">
      <div className="mx-3 min-[400px]:mx-4 sm:mx-[30px] md:mx-[50px] lg:mx-[50px] header-1080 xl:mx-[50px] header-4k mt-6 mb-12 md:mb-16 space-y-14 sm:space-y-16 md:space-y-20">
        <AboutHero />
        <AboutStats />
        <AboutTrust />
        <AboutTeam />
