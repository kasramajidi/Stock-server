    ...
    <div className="relative w-full max-w-md mx-auto">
      <div className="relative aspect-square rounded-2xl overflow-hidden bg-gray-50 border border-gray-100">
        ...
        <button
          ...
          className="absolute top-3 right-3 w-10 h-10 rounded-2xl bg-white/95 border border-gray-200 flex items-center justify-center shadow-sm hover:bg-white transition-colors cursor-pointer"
