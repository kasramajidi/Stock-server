...
export default function TrustBanner() {
  return (
    <section className="w-full py-8 sm:py-10 bg-gray-50/80">
      <div className="mx-3 min-[400px]:mx-4 sm:mx-6 md:mx-8 lg:mx-10 xl:mx-12">
        ...
        <div className="relative px-1 sm:px-3 md:px-6 lg:px-10">
          ...
          >
            ...
            <CarouselPrevious className="right-auto -left-2 sm:-left-4 md:-left-6 lg:-left-10 z-10 size-9 sm:size-10 bg-white border border-gray-200 shadow-md hover:bg-[#00DDFF] hover:text-white hover:border-[#00DDFF] [&_svg]:size-5" />
            <CarouselNext className="-right-2 sm:-right-4 md:-right-6 lg:-right-10 z-10 size-9 sm:size-10 bg-white border border-gray-200 shadow-md hover:bg-[#00DDFF] hover:text-white hover:border-[#00DDFF] [&_svg]:size-5" />
          </Carousel>
        </div>
      </div>
    </section>
