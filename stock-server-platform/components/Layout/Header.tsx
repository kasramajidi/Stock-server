...
export default function Header({
  ...
  return (
    <div className="bg-white shadow-md rounded-2xl sm:rounded-3xl z-50 mx-3 min-[400px]:mx-4 sm:mx-6 md:mx-8 lg:mx-10 header-1080 xl:mx-12 2xl:mx-14 min-[1700px]:mx-16 min-[1920px]:mx-20 header-4k border border-gray-200 relative -mt-[5px]">
      <div className="container mx-auto px-3 min-[400px]:px-4 sm:px-4 md:px-6 lg:px-8 xl:px-10 2xl:px-12 min-[1700px]:px-14 min-[1920px]:px-16 py-3 sm:py-3.5 md:py-4 lg:py-3.5 xl:py-4">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-3 sm:gap-3 lg:gap-4">
          <div className="flex items-center justify-between w-full lg:w-auto lg:order-3">
            ...
            <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
              ...
              >
                ...
                <span className="text-xs sm:text-sm font-medium whitespace-nowrap md:text-base">
          ...
          <div className="hidden lg:flex items-center gap-4 lg:order-1 w-full lg:flex-1 min-w-0">
            <Link
              href="/"
              className="relative w-[120px] h-[44px] lg:w-[128px] lg:h-[46px] xl:w-[136px] xl:h-[48px] shrink-0"
            >
              <Image
                src="/Images/Logo/logo stock copy 2.png"
                alt="استوک سرور - Stock Server"
                ...
                className="object-contain"
                priority
                sizes="(max-width: 1280px) 120px, (max-width: 1536px) 128px, 136px"
              />
            </Link>

            <div className="flex-1 flex justify-center lg:px-6 xl:px-8 min-w-0">
              <div className="w-full max-w-2xl xl:max-w-3xl">
                <Suspense
                  fallback={
                    <div className="h-10 w-full rounded-3xl bg-gray-100 animate-pulse" />
                  }
                >
                  <SearchBar />
                </Suspense>
