...
> = {
  ...
  "gift-card-visa": {
    features: [
      ...
      "پشتیبانی ريتكس - پشتیبانی ريتكس ۲۴ ساعته به شما کمک خواهد کرد",
    ],
    steps: ["ثبت درخواست", "بررسی و تایید", "انجام خدمت", "تایید نهایی"],
    description:
  ...
  "mastercard-personal": {
    features: [
      "قابلیت شارژ مجدد - شارژ کارت‌ها در هر ماه فقط تا سقف ۲۷۵۰ لیر با کارمزد ۶٪ از طریق ريتكس صورت می‌گیرد",
